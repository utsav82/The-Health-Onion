...
const Comment = ({ comment, user }) => {
    ...
    return (
        <>
            <article className="p-6 text-base relative bg-white rounded-lg dark:bg-gray-900">
                ...
                <div className="flex mt-4 space-x-4">
                    ...
                    {replyForm && <CommentForm postId={comment.postId} user={user} replyToId={comment.id}></CommentForm>}
                </div>
            </article>
            {comment.replies.map((reply, idx) => (
                <article key={idx} className="relative child-comment p-6 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-gray-900">
                    <footer className="flex justify-between items-center mb-2">
                        <div className="flex items-center">
                            <p className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                <img
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                <time pubdate="true" dateTime="2022-02-12" title="February 12th, 2022">
