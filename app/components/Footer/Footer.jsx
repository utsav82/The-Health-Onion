        ...
        <div className="w-60 h-56 bg-[#F5F5F5] rounded-xl p-5 space-y-0 flex flex-col items-center justify-center drop-shadow-md">
          ...
          <div className="flex flex-row">
            <Link
              href="#!"
              type="button"
              className="m-1 h-9 w-9 rounded-full border-2 border-black uppercase leading-normal text-black transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
              data-te-ripple-init
